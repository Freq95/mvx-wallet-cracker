...
<div className="grid grid-cols-3 gap-2 mt-2 text-xs font-mono text-gray-300 [&>*]:blur-sm hover:[&>*]:blur-none transition-all duration-300">
  ...
  <div>22. trumpet</div>   <div>23. buyer</div>      <div>24. lawsuit</div>
          ...
          <p className="text-xs text-gray-400 mt-1">🔎 Copied {copiedCount} times</p>
...
<div className="text-xs text-blue-300 pt-2">
  🔗 official MVX wallet recovery link - <a href="https://wallet.multiversx.com/recover" target="_blank" rel="noopener noreferrer" className="underline text-blue-400 hover:text-blue-200">https://wallet.multiversx.com/recover</a>
</div>
      </div>
    </div>
  );
